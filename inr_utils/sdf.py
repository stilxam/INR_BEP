...
#     coords = jax.random.uniform(key, shape=(100, 3), minval=-1., maxval=1.)
#     target_sdf = target_SDF("Armadillo", 100, True, key)
#     print(target_sdf(coords).shape)