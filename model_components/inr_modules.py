...
class MLPINR(INRModule):
    ...
    def new_from_config(
        ...
        hidden_layers = []
        if num_layers>2:
            hidden_layers.append(initialization_scheme(
        ...
        return cls(input_layer=first_layer, hidden_layers=hidden_layers, output_layer=out_layer, post_processor=post_processor)
